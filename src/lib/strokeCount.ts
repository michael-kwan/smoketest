...
export const STROKE_COUNTS: { [key: string]: number } = {
  ...
  '都': 11, '個': 10, '來': 8, '他': 5, '時': 10, '會': 13, '地': 6, '得': 11, '對': 14,
  '出': 5, '年': 6, '要': 9, '下': 3, '過': 12, '主': 5, '從': 11, '多': 6,
  ...
  // Time and dates
  '日': 4, '月': 4, '分': 4, '秒': 9, '今': 4, '昨': 9, '明': 8,
  '午': 4, '晚': 11, '夜': 8, '春': 9, '夏': 10, '秋': 9, '冬': 5, '星': 9, '期': 12,
  
  // Places
  '家': 10, '屋': 9, '房': 8, '門': 8, '窗': 12, '床': 7, '桌': 10, '椅': 12, '廁': 7, '廚': 12,
  '街': 12, '路': 13, '站': 10, '店': 8, '場': 12, '園': 13, '校': 10, '院': 14, '所': 8,
  ...
  // Transportation
  '車': 7, '巴': 4, '士': 3, '船': 11, '飛': 9, '機': 16, '火': 4, '單': 12,
  
  // Numbers and counting
  '百': 6, '千': 3, '萬': 13, '億': 15, '零': 13, '半': 5, '雙': 18, '打': 5,
  
  // Common sentence particles and function words
  '緊': 14, '住': 7, '仲': 6, '已': 3, '經': 13, '先': 6,
  '再': 6, '又': 2, '同': 6, '或': 8, '者': 8, '但': 7, '如': 6, '果': 8, '因': 6,
  '為': 9, '以': 4, '雖': 17, '然': 12, '而': 6, '且': 5, '除': 10, '非': 8, '只': 5,
  
  // Actions and verbs
  '行': 6, '走': 7, '跑': 12, '跳': 13, '企': 6, '坐': 7, '瞓': 16, '起': 10, '落': 12,
  '入': 2, '開': 12, '關': 19, '着': 11, '穿': 9, '洗': 9, '刷': 8, '擦': 17,
  '掃': 11, '拖': 8, '抹': 8, '煮': 12, '炒': 8, '蒸': 13, '煎': 13, '炸': 9, '烤': 10, '燒': 16,
  
  // Emotions and feelings
  '興': 16, '樂': 15, '喜': 12, '歡': 22, '愛': 13, '恨': 9,
  '怕': 8, '驚': 22, '怒': 9, '傷': 13, '擔': 16, '放': 8,
  
  // Directions
  '東': 8, '南': 9, '西': 6, '北': 5, '左': 5, '右': 5,
  '內': 4, '外': 5, '裏': 12, '旁': 10, '隔': 12, '離': 19,
  
  // Technology and modern terms
  '話': 13, '腦': 13, '網': 14, '器': 16, '視': 11, '音': 9,
  '片': 4, '戲': 17, '遊': 12, '書': 10, '報': 12, '紙': 10, '筆': 12, '字': 6, '畫': 12
}
